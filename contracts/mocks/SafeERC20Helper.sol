...
contract SafeERC20Helper {
    ...
    function doSucceedingApprove(uint256 amount_) public {
        _succeeding.safeApprove(address(0), amount_);
    }

    function doSucceedingIncreaseAllowance(uint256 amount_) public {
        _succeeding.safeIncreaseAllowance(address(0), amount_);
    }

    function doSucceedingDecreaseAllowance(uint256 amount_) public {
        _succeeding.safeDecreaseAllowance(address(0), amount_);
    }
